/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --strict-vars=false` (hash: a7eccefc5045a7bdbb097db7522cb478)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "InventoryAgent" | "AccessorTrapAgent";
	}
	interface Env {
		InventoryAgent: DurableObjectNamespace<import("./src/test-worker").InventoryAgent>;
		AccessorTrapAgent: DurableObjectNamespace<import("./src/test-worker").AccessorTrapAgent>;
	}
}
